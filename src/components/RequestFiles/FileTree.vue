        ...
        <div v-else class="treeview">
            ...
            <div v-show="expanded">
                <div v-if="fileTree.children.length <= 0" class="list-group">
                    <file-tree v-bind:file-tree="null" />
                </div>
                <div v-for="(tree, index) in fileTree.children" :key="index" class="list-group">
                    <file-tree @open-file="(filePath: string) => emit('open-file', filePath)" v-bind:file-tree="tree"
